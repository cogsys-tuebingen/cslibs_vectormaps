...
template<std::size_t _Nm>
inline cslibs_vectormaps::math::Index<_Nm> operator - (const cslibs_vectormaps::math::Index<_Nm>& __one,
                                                       const cslibs_vectormaps::math::Index<_Nm>& __two)
{
    cslibs_vectormaps::math::Index<_Nm> __res;
...
template<std::size_t _Nm>
inline cslibs_vectormaps::math::Index<_Nm> operator - (const cslibs_vectormaps::math::Index<_Nm>& __idx,
                                                       const int __scalar)
{
    cslibs_vectormaps::math::Index<_Nm> __res;
    for(std::size_t i = 0 ; i < _Nm; ++i)
